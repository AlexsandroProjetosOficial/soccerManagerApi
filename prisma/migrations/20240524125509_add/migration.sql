...
INSERT INTO "new_game_details" ("created_at", "first_half", "game_id", "id", "player_number_one", "player_number_two", "second_half", "stop", "team_id", "time", "type") SELECT "created_at", "first_half", "game_id", "id", "player_number_one", "player_number_two", "second_half", "stop", "team_id", "time", "type" FROM "game_details";
